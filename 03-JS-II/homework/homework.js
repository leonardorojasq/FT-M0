...
/*
eva, Para implementar la siguiente función vamos a utilizar una estructura de control de flujo nu
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  var canidaddedigitos = 0;
  while(Math.floor(numero) != 0){
    numero = numero / 10;
    canidaddedigitos ++;

  }
  if(canidaddedigitos === 3) return true
  else return false;
}
